<template>
    <v-container justify="center">
        <v-sheet elevation="10" rounded="xl" maxHeight="650">
            ...
            <div class="pa-4">
                <v-chip-group v-model="this.selectedEventIDs" v-on:child-to-parent="receiveDataFromChild" multiple
...
export default {
    ...
    data() {
        ...
        return {
            ...
            selectedEventIDs: useAccessoireStore().selectedEventIDs,
    ...
    mounted() {
        this.accessoireStore.getAccessoires();
        this.selectedEventIDs =  (this.vin)? vehicleStore.vehicle.local.selectedAccessoire : [];
    },
};
</script>
